...
export default function Projects() {
  const projectsArray = [
    {
      image: "../src/assets/projects/gardian.png",
      Project_name: "GUARDIAN",
      Project_discription: "Mobile app and web app system for travel security Mobile app and web app system for travel security",
      Used_languages: "React Native | Node.js | Express.js | MongoDB |EXPO",
    },
    {
      image: "../src/assets/projects/OPENHEART.png",
      Project_name: "Zolo",
  ...
  return (
    <div className="grid grid-cols-2 gap-16  p-10  ">
      {projectsArray.map((Pitem, Pindex) => (
        <div key={Pindex} className=" flex flex-col  hover:shadow-[#025a62]  shadow-lg rounded-3xl " >
          <div className=" bg-flex justify-center items-center rounded-3xl h-projet w-full mb-3">
            <img src={Pitem.image} className="rounded-3xl  object-fill h-projet "></img>
          </div>
